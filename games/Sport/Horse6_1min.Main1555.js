...
registrationAppOnPlatform({
    category: 'Sport',
    catalog: 'Horse6 1 min',
    image: 'games/Sport/resources/icons/horse6-1min-1.png',
    imageBack: 'games/Sport/resources/icons/horse6-1min-2.png',
    caption: 'Horse6 1 min',
    runConfig: 'Horse6',
    gameType: 'normal',
    playInDemo: false,
    sid: 17
...
function emitEventHorse6(eventName, eventData) {
}

function initHorse6Object(form, type) {
    console.log('initHorse6Object', form, type);
    window.flgStopRotate = true;
    Horse6App(form);
}

function Horse6App(form) {
    function closeApp() {
    ...
    function getGameURL() {
        ...
        let url = `/Gamer_games/horse1min/index.html?crdn=${crdn}&lang=${lang}&home=${backURL}`;
